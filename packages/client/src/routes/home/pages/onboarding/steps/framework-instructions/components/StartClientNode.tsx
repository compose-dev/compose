...
function StartClientNode({ code }: { code: string }) {
  return (
    <FrameworkStep>
      <h4>3. Start the Compose Client</h4>
      <p>
        In the main entry point of your project, e.g.{" "}
        <InlineCode>index.ts</InlineCode>, import the Compose Client that you
        exported in the previous step and initialize it:
      </p>
